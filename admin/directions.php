...
If the directory is not writable you should be seeing an error message at the top of the plugin admin pages.<br /><br />
		...
		Alternatively, you can also add images to the /wp-content/plugins/custom-header/header-images/ directory using your FTP client or other file manager.<br /><br />
