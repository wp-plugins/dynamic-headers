...
<?php
	...
	if($_POST['altUpdate'] == 'yes'){
		update_option('dhnd_'.$_POST['mediaHeader'], $_POST['altText']);
		echo '<div style="background-color: rgb(255, 251, 204);" id="message" class="updated fade"><p>File: <strong>'.$_POST['mediaHeader'].'</strong> has been updated with the new alt/title tag of: <strong>'.$_POST['altText'].'</strong>.</p></div>';
	}
?>
	<h3>Delete Files</h3>
