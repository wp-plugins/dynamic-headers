...
1. Go to the Settings Page (under the Headers menu created by the plugin) and set your default header image. If you do not set a default header image, no media will be shown for posts and pages that do not have a header image associated with it.Alternatively, you can also add images to the `/wp-content/plugins/dynamic-headers/header-images/` directory using your FTP client or other file manager.
